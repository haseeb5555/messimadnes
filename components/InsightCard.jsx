...
const InsightCard = ({imgUrl ,title ,subtitle,index}) => (
  ...
  >
    ...
    src={imgUrl}
     alt="planel-01"
     className="md:w-[270px] w-full lg:h-[350px] h-[250px]
    ...
    <h4 className="text-normal lg:text-[42px] text-[26px] text-white"> {title}</h4>
    <p className="mt-[16px] font-normal lg:text-[20px] text-[14px] text-secondary-white"> {subtitle}</p>
    </div>
     <div className="lg:flex hidden items-center justify-center w-[100px] h-[100px] 
